...
def add_reseller(message):
    ...
    if len(command) != 3:
        bot.reply_to(message, "�_U𝘀𝗮𝗴𝗲: /𝗮𝗱𝗱𝗿𝗲𝘀𝗲𝗹𝗹𝗲𝗿 <𝘂𝘀𝗲𝗿_𝗶𝗱> <𝗯𝗮𝗹𝗮𝗻𝗰𝗲>")
        return
    ...
    if reseller_id not in resellers:
        ...
        bot.reply_to(message, f"✅ 𝗥𝗲𝘀𝗲𝗹𝗹𝗲𝗿 𝗮𝗱�_d𝗲𝗱 𝘀𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 ✅\n\n𝗥𝗲𝘀𝗲𝗹𝗹𝗲𝗿 𝗜𝗗: {reseller_id}\n𝗕𝗮𝗹𝗮𝗻𝗰𝗲: {initial_balance} Rs")
    else:
...
def generate_key(message):
    ...
    if user_id in admin_id:
        ...
        if resellers[user_id] >= cost:
            ...
            keys[key] = {"duration": duration, "expiration_time": None}
            save_keys()
            response = f"✅ 𝗞𝗲𝘆 𝗴𝗲�_n𝗲𝗿𝗮𝘁𝗲𝗱 𝘀𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 ✅\n\n𝗞𝗲𝘆: `{key}`\n𝗗𝘂𝗿𝗮𝘁𝗶𝗼𝗻: {duration}\n𝗖𝗼𝘀𝘁: {cost} Rs\n𝗥𝗲𝗺𝗮𝗶𝗻𝗶𝗻𝗴 𝗯𝗮𝗹𝗮𝗻𝗰𝗲: {resellers[user_id]} Rs"
        else:
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘�_L𝗖𝗢𝗠𝗘 𝗧𝗢 𝗩𝗜𝗣 𝗗𝗗𝗢𝗦!", reply_markup=markup)
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if time > 240:
                ...
                # Run attack asynchronously without shell=True
    ...
    if user_id in admin_id:
        ...
        if resellers:
            for reseller_id, balance in resellers.items():
                ...
                resellers_info += f"• �_U𝘀𝗲𝗿𝗻𝗮𝗺𝗲: {reseller_username}\n  𝗨𝘀𝗲𝗿𝗜𝗗: {reseller_id}\n  𝗕𝗮𝗹𝗮𝗻𝗰𝗲: {balance} Rs\n\n"
        else:
            resellers_info += "𝗡𝗼 �_r𝗲𝘀𝗲𝗹𝗹𝗲𝗿 𝗳𝗼𝘂𝗻𝗱"
...
def add_balance(message):
    ...
    if user_id in admin_id:
        ...
        bot.reply_to(message, "⛔️ 𝗔𝗰𝗰𝗲𝘀𝘀 𝗗𝗲𝗻𝗶𝗲𝗱: 𝗔𝗱𝗺𝗶𝗻 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮�_n𝗱")
    ...
    if user_id in admin_id:
        try:
            ...
            if len(command_parts) != 2:
                bot.reply_to(message, "𝗨𝘀𝗮𝗴𝗲: /�_r𝗲𝗺𝗼𝘃𝗲_𝗿𝗲𝘀𝗲𝗹𝗹𝗲𝗿 <𝗿𝗲𝘀𝗲𝗹𝗹𝗲𝗿_𝗶𝗱>")
                return
