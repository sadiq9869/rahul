...
void showUsage(const char* progName) {
    std::cout << RED << "Invalid usage!" << RESET << "\n\n";
    std::cout << CYAN << "Correct Format:\n";
    std::cout << YELLOW << "  " << progName << " <IP> <Port> <Duration> <PacketSize>\n" << RESET;
    std::cout << GREEN << "\nExamples:\n"
              << "  " << progName << " 1.1.1.1 3074 60 1367\n"
              << "  " << progName << " 192.168.0.1 80 120 1024\n"
              << RESET;
