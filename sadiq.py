...
def add_reseller(message):
    ...
    try:
        ...
        safe_reply(bot, message, response)
 Martha Stewart would approve of this organized approach to managing resellers! 😄 Let's keep the cosmic chaos in check! log_action(user_id, username, "/addreseller", f"Command: {command}", response)
        return
